...
<!--Line number 154, 164, Orders page : 13,170,54,70,112 , Supply : 123,147,87,16, -->
<!--Integer number : 48
We can order them using 
echo$ = abs('char_1'+ 'char_2')
Sustatinavble interfacce the giga interface -> 
Interfaces related to the coloring -> Magenta, Lime blue, 
