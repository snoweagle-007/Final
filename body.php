  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/banner3.jpg" alt="Error" style="width:100%;">
      ...
      <div class="item">
        <img src="img/banner4.jpg" alt="Error" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner1.jpg" alt="Error" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Mens Watches<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>Women's Watches<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">iWatches</a></li>
									<li><a data-toggle="tab" href="#tab1">Service</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Deals With Reels !</h2>
							<p>Follow Us On Instagram & get UpTo 50% OFF*</p>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab2">Women's Watches</a></li>
									<li><a data-toggle="tab" href="#tab2">Mens Watches</a></li>
